                              ...
                              <div class="col-span-6 sm:col-span-6">
                                ...
                                <div class="mt-1 flex items-center">
                                  ...
                                  <button type="button" class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    <input type="file" @change="updateProfile" name="avatar" id="avatar" class="form-input">
                                  </button>
                                </div>
                              </div>
    ...
    export default {
        ...
        methods:{
            ...
            updateInfo(){
                ...
                this.form.post(process.env.MIX_APP_URL+`/api/developer/${this.$route.params.id}`)
                .then(()=>{
        ...
        created() {
            this.axios
                .get(process.env.MIX_APP_URL+`/api/developers/${this.$route.params.id}`)
